...
const cultureData = [
  ...
  },
  {
    ...
    description: "There’s always a new and better way to do it, say it, design it. At least that’s what we like to think.",
    image: "/6.png",
    tab: "Growth",
  },
];
...
export default function AboutPage() {
  ...
  return (
    <main className="bg-black text-gray-300">
      {/* HERO */}
      <section className="w-full px-4 sm:px-6 md:px-10 lg:px-16 py-12 border-t border-purple-900">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-semibold italic text-[var(--brand-purple)]">
              We are Velocitta
            </h1>

            <h2 className="mt-3 text-gray-400 text-lg sm:text-xl md:text-2xl italic">
          ...
          {/* Image */}
          <div className="mt-8">
            <div className="relative w-full h-[220px] sm:h-[320px] md:h-[420px] lg:h-[520px] overflow-hidden rounded-md">
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
            {[1].map((col) => (
              <div key={col} className="space-y-6 max-w-xl">
                <p className="text-sm sm:text-base md:text-lg text-gray-400 leading-relaxed">
                  ...
                  marketing communication, and employer branding, we take
                  immense pride in our 16 year legacy of serving our valued
                  clients. Our unique approach combines the resources of a
                  larger agency with the nimbleness of a startup, empowering
                  businesses to spotlight their core values and convey the
                  significance of their work through the captivating art of
                  storytellingadgegeg.
                </p>
                <p className="text-sm sm:text-base md:text-lg text-gray-400 leading-relaxed">
                  Yet, our commitment extends beyond delivering exceptional
                  results for our clients. We are equally dedicated to
                  cultivating a thriving, supportive, and inclusive work
            ...
            {[2].map((col) => (
              <div key={col} className="space-y-6 max-w-xl">
                ...
                <p className="text-sm sm:text-base md:text-lg text-gray-400 leading-relaxed">
                  Within Velocitta India, we’ve cultivated a culture that not
                  only places high value on our clients’ objectives but also
                  ...
                  passion for excellence and a profound appreciation for those
                  who contribute to our shared success – both our cherished
                  clients and our exceptional team
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="w-full px-4 sm:px-6 md:px-10 lg:px-16 py-16 border-t border-purple-900">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-semibold text-purple-400">
            Our culture and values mean a lot to us
          </h2>

          <div className="mt-8 border-purple-900 rounded-xl p-6 md:p-10">
            {/* SLIDER WRAPPER */}
              ...
              >
                {cultureData.map((item, index) => (
                  ...
                  >
                    {/* TEXT */}
                    <div>
                      <h3 className="text-3xl md:text-4xl font-semibold text-purple-400">
                        {item.title}
                      </h3>
      ...
      {/* STATS */}
      <section className="w-full bg-black text-white py-16 px-4 sm:px-6 md:px-10 lg:px-16 border-t border-purple-900">
