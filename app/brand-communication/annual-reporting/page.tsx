  ...
  return (
    <main className="bg-black text-white" role="main">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-sm sm:text-base text-white/70 leading-relaxed">
              At Velocitta India, we transform complex financial, ESG, and
              sustainability data into compelling narratives that clearly
      ...
      <section className="w-full border-t border-purple-900">
        <div className="bg-gradient-to-r from-purple-900 to-black py-10 sm:py-12 md:py-14 px-4 sm:px-6 md:px-10 lg:px-16 text-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* LEFT CARD */}
              <div className="border border-white/10 rounded-xl p-6 md:p-8 bg-white/5 backdrop-blur-sm hover:border-purple-400 transition">
                <div className="mb-4">
                ...
                <p className="text-sm text-white/70 mb-4 leading-relaxed">
                  ...
                  communicate your organization’s financial performance,
      ...
      <section className="w-full bg-[var(--brand-black)] border-t border-purple-900">
