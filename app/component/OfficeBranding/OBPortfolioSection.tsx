  ...
  return (
    <section className="w-full bg-[var(--brand-black)] text-white pt-12 pb-10 md:pt-14 md:pb-12 border-b border-purple-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10">
        ...
        <p className="text-sm sm:text-base text-white/70 leading-relaxed  mb-8 sm:mb-12">
          Our portfolio is a visual testament to how Velocitta Brands, a premier
          office branding agency, transforms mundane workspaces into magnetic
          brand experiences. As a strategic workplace branding agency, we
          deliver custom office branding that goes beyond aesthetics to motivate
          teams and communicate your core values instantly.
        </p>
